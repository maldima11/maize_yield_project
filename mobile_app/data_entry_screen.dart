// Full form — GPS capture, district/ward/variety dropdowns, soil readings, planting date
...
class _DataEntryScreenState extends State<DataEntryScreen> {
  ...
  Future<void> _getLocation() async {
    ...
    try {
      ...
      _showSnack('📍 GPS captured: ${_lat!.toStringAsFixed(5)}, ${_lon!.toStringAsFixed(5)}');
    } catch (e) {
      setState(() => _isLocating = false);
    ...
    if (mounted) {
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: const Text(
            'Field data saved locally.\n\nIt will automatically sync to the server when you are back online.',
          ),
          actions: [
            ElevatedButton(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  'Data is saved offline and synced when online',
